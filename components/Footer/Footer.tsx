      ...
      <Grid stackable>
        <Grid.Row>
          ...
          <Grid.Column width={7}>
            ...
            <p>
              <a href="https://platzi.com/">Platzi y su curso de Next.JS</a> desarrollado por JuDevRo{' '}
              <a href="https://github.com/JuDevRo">@judevro</a>
            </p>
            <List horizontal style={{ display: 'flex' }}>
              ...
              <List.Item
                ...
                style={{ display: 'flex' }}
                content={
                  <a href="https://github.com/JuDevRo">
                    GitHub
                  </a>
                }
              />
